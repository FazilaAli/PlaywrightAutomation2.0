...
public class Area extends BaseTest {
    ...
    public void Area() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Area']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Area']")).isVisible();
        ...
        sh.clickDropdownSelectLocation();
