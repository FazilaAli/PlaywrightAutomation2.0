package testcases.Configuration.SystemHierarchy;
...
public class Location extends BaseTest {
    ...
    public void Location() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Location']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Location']")).isVisible();
        ...
        ac.enterAccessLevelTitle("Automation");

        sh.clickDropdownSelectOption();

        sh.clickOptionMadina();

        us.clickSave();

        ac.enterSecondaryTitle("Automation");
