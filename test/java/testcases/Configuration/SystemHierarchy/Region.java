...
public class Region extends BaseTest {
    ...
    public void Region() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Region']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Region']")).isVisible();
