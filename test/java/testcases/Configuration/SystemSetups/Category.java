...
public class Category extends BaseTest {
    ...
    public void Category() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Category']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Category']")).isVisible();
