...
public class Country extends BaseTest {
    ...
    public void Country() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Country']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Country']")).isVisible();
        System.out.println("Title Verified Successfully.");

        page.waitForTimeout(5000);

        // Set Access Level for Search
        ac.enterSearchInput("CAPE VERDE");
        ...
        // Delete Record
        atr.clickDeleteIcon("CAPE VERDE");
        at.clickDelete();
        ...
        ss.enterCountryTitle("CAPE VERDE");

        ss.enterNationalityTitle("CAPE VERDEAN");

        ss.enterCountryCode("CV");

        ss.enterDialingCode("238");

        us.clickSave();

        ss.enterCountryTitle2("CAPE VERDE");

        us.clickSave();

        ss.enterNationalityTitle2("CAPE VERDEAN");
        ...
        Locator toggle3 = page.locator("//tr[./td[normalize-space()='CAPE VERDE']]//input[@type='checkbox' and @aria-checked='true']");
        assertThat(toggle3).isVisible();
        System.out.println("Status Active Verified Successfully.");

        us.clickStatus3("CAPE VERDE");
        ...
        Locator toggle4 = page.locator("//tr[./td[normalize-space()='CAPE VERDE']]//input[@type='checkbox' and @aria-checked='false']");
...
//
//        // Verify active toggle
//        Locator toggle4 = page.locator("//tr[./td[normalize-space()='CAPE VERDE']]//input[@type='checkbox' and @aria-checked='true']");
//        assertThat(toggle4).isVisible();
//        System.out.println("Status Active Verified Successfully.");
