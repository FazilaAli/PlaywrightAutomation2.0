...
public class Designation extends BaseTest {
    ...
    public void Designation() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Designation']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Designation']")).isVisible();
