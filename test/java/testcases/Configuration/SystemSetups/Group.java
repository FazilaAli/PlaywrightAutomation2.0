...
public class Group extends BaseTest {
    ...
    public void Group() {
        ...
        // Title assertion
        page.locator("//p[text()='List of Group']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Group']")).isVisible();
