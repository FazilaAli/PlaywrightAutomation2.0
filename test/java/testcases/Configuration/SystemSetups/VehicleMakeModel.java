...
public class VehicleMakeModel extends BaseTest {

    @Test
    public void VehicleMakeModel() {
        ...
        hp.clickVehicleMakeModel();

        // Title assertion
        page.locator("//p[text()='List of Make Model']").waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertThat(page.locator("//p[text()='List of Make Model']")).isVisible();
